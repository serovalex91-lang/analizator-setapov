#!/usr/bin/env python3
"""
Тестовый скрипт для проверки обработки HBAR сообщения
"""
import asyncio
import sys
import os
...
async def test_hbar_message():
    """Тестируем обработку сообщения HBAR"""
    
    # Тестовое сообщение
    test_message = "$HBAR 🟥🟢🟢🟢🟢 frame:30M"
    
    print("=" * 60)
    print("ТЕСТИРОВАНИЕ HBAR СООБЩЕНИЯ")
    print("=" * 60)
